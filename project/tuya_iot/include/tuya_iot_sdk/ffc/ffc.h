...
#define FFC_VERSION                 0x01
#define FFC_BINDING_SEQ             0x01
#define FFC_BINDING_HIP             0x01
#define FFC_BEACON_HIP              0x01
#define FFC_CONTROL_HIP             0x03
...
#define FFC_BIND_STEP_0             0x00
#define FFC_BIND_STEP_1             0x01

#define FFC_BIND_SETP               FFC_BIND_STEP_0
...
typedef struct {
    ffc_slave_list_t *slave;

    ffc_slave_list_t  slave_list[FFC_MAX_SLAVE_COUNT];
...
// extern ffc_master_t *ffc_master_static(void);
...
extern int ffc_master_binding_slave(ffc_master_t *master, uint8_t binding_time);
extern int ffc_master_unbinding_slave(ffc_master_t *master, uint8_t binding_time);
...
#define FFC_SLAVE_MAX_FORWARD_BEACON_MSG    5
#define FFC_SLAVE_MAX_PKT_SEQ_NUM           10

#define FFC_FORWARD_BEACON_RANDOM_ENABLE    0
#define FFC_SLAVE_BEACON_RANDOM_MIN_MS      10
#define FFC_SLAVE_BEACON_RANDOM_MAX_MS      30

#define FFC_SLAVE_BINDING_MIN_MS            80
#define FFC_SLAVE_BINDING_MAX_MS            110

#define FFC_SLAVE_ELECT_DISABLE             0  
#define FFC_SLAVE_ELECT_ACTIVE_TIME         150
#define FFC_SLAVE_ELECT_SLEEP_TIME          3000

#define FFC_FORWARD_CMD_RANDOM_ENABLE       1
#define FFC_SLAVE_MAX_FORWARD_CMD_MSG       3
#define FFC_SLAVE_CMD_RANDOM_MIN_MS         10
#define FFC_SLAVE_CMD_RANDOM_MAX_MS         50


typedef struct {
    uint16_t  data[FFC_SLAVE_MAX_PKT_SEQ_NUM];
    uint16_t  index;
} ffc_seq_t;;
...
// extern ffc_slave_t *ffc_slave_static(void);
extern ffc_slave_t *ffc_slave_malloc(void);
extern int ffc_slave_binding_master(ffc_slave_t *slave, uint8_t binding_time);
extern int ffc_slave_init(ffc_slave_t *slave, ffc_cfg_t *cfg, ffc_ops_t *ops, ffc_cb_t *cb);
extern int ffc_slave_frame_parser(ffc_slave_t *slave, 
                                  uint8_t     *frame, 
                                  uint32_t     frame_len, 
                                  uint8_t      src_mac[6], 
                                  uint8_t      dst_mac[6]);
